...
const navigation = [
    ...
    { name: 'Prices/FAQ', href: '/services', current: false },
    ...
    <div className="bg-tealGreen-100">
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        <Dialog className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full max-w-sm overflow-y-auto bg-tealGreen-100 px-6 py-6 sm:ring-1 sm:ring-gray-900/10">

...
function ServicesFAQ() {
  const [showTattoosFAQ, setShowTattoosFAQ] = useState(false);
  const [showPiercingsFAQ, setShowPiercingsFAQ] = useState(false);

  const toggleTattoosFAQ = () => {
    setShowTattoosFAQ(!showTattoosFAQ);
  };

  const togglePiercingsFAQ = () => {
    setShowPiercingsFAQ(!showPiercingsFAQ);
  };
            ...
            {showTattoosFAQ && (
              <div className="mx-auto max-w-lg bg-tealGreen-100">
                <div className="space-y-6">
                  ...
                  <details className="group rounded-xl bg-tealGreen-100 shadow-[0_10px_100px_10px_rgba(0,0,0,0.05)]">
                    <summary className="flex cursor-pointer list-none items-center justify-between p-6 text-lg font-medium text-black">
                      Can I bring someone to my appointment?
                      <div className="text-secondary-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="block h-5 w-5 transition-all duration-300 group-open:-rotate-90">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg>
                      </div>
                    </summary>
                    <div className="px-6 pb-6 text-black">You may bring someone with you to your appointment, however they may not be permitted into the tattoo area. This is for several reasons: <br /> <br /> Due to health and safety- during the procedure we are dealing with bodily fluids and essentially open woulds- we need to minimise the risk of contamination. The dignity of our customers- for some tattoos our customers are required to adjust their clothing and discretion is required. Busy studio- if the studio is busy there may simply not be room for your friend to come along! <br /> <br /> Some exceptions may be permitted, let us know before coming to your appointment. We politely remind customers that our studio is not child friendly, no children are permitted in the main studio and we ask that they are not in the reception area for any extended period of time. We are not babysitters and take no responsibility for children left unattended.</div>
                  </details>
                  <details className="group rounded-xl bg-tealGreen-100 shadow-[0_10px_100px_10px_rgba(0,0,0,0.05)]">
                    <summary className="flex cursor-pointer list-none items-center justify-between p-6 text-lg font-medium text-black">
                  ...
                  <details className="group rounded-xl bg-tealGreen-100 shadow-[0_10px_100px_10px_rgba(0,0,0,0.05)]">
                    ...
                    <div className="px-6 pb-6 text-black">Short answer - no. Although the risk of infection is incredibly small, it is a possibility if aftercare is not followed. Also, pregnancy can send the body into a healing overdrive and cause the ink to reject, and we dont want that to happen!! </div>
                  </details>
                  <details className="group rounded-xl bg-tealGreen-100 shadow-[0_10px_100px_10px_rgba(0,0,0,0.05)]">
                    <summary className="flex cursor-pointer list-none items-center justify-between p-6 text-lg font-medium text-black">
                    ...
                    <div className="px-6 pb-6 text-black">Yes! We are on one level with disabled access bathrooms. There is a step up into the reception area, please let us know beforehand and we can make sure this is safely navigable for wheelchair users prior to your appointment. </div>
                  </details>
                  <details className="group rounded-xl bg-tealGreen-100 shadow-[0_10px_100px_10px_rgba(0,0,0,0.05)]">
                    <summary className="flex cursor-pointer list-none items-center justify-between p-6 text-lg font-medium text-black">
                      Payment
                    ...
                    <div className="px-6 pb-6 text-black">We are currently a CASH ONLY studio. Artists can be paid by bank transfer or cash only. There are several cash machines less than 50m from the shop entrance.

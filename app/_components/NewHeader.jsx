  ...
  <div className="mx-auto px-4 max-w-screen-xl py-32 lg:flex lg:items-center">
    <div className="mx-auto mx-15 lg:mx-46 sm:mx-1 text-center">
      ...
      <p className="mx-auto mt-4 text-center sm:text-xl/relaxed text-black font-bold">
        Based in the heart of Dundee City Centre, we pride ourself on being a
        welcoming and inclusive environment. With nearly 40 years of Tattoo and
        Piercing experience between us, we can help you get the tattoo or
        piercing you desire.
        <br />
        <br />
        From small pieces to larger projects, we cover a variety of tattoo
        styles and themes, with each artist having their own particular favoured
        style. Please check out the Artists page and look at their work to help
        you find the artist that is right for you.

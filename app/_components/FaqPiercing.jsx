...
function FaqPiercing() {
  return (
    <div className="bg-tealGreen-100">
    <div class="mx-auto max-w-lg bg-tealGreen-100">
      <h1 className='text-center text-tealGreen-500 text-2xl'>Frequently Asked Questions</h1>
  <div class="space-y-6">
    <details class="group rounded-xl bg-tealGreen-200 shadow-[0_10px_100px_10px_rgba(0,0,0,0.05)]">

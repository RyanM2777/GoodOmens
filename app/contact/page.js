...
export const metadata = {
  title: 'Good Omens - Tattoo & Piercing | Contact',
...
function page() {
  return (
    ...
    <title>{metadata.title}</title>
      ...
      <meta property="og:url" content="https://goodomenstattoo.co.uk/contact" />
      ...
      <meta property="twitter:url" content="https://goodomens.co.uk/contact" />
...
{/* Favicon */}
 ...
 <link rel="icon" href="/GoodOmensCircle.png" type="image/x-icon" />
      ...
      {/* Canonical Tag */}
      <link rel="canonical" href="https://www.goodomenstattoo.co.uk/contact" />
    </>
  )
}
